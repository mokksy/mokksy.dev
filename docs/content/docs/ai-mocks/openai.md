...
toc: true
summary: |-
  Mock OpenAI APIs locally. AI-Mocks supports Chat Completions, Responses, Embeddings, Moderations, streaming, and error simulation with LangChain4j and Spring AI integrations.
---
